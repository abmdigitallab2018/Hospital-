...
<template>
    <AdminLayout>
        <Head title="Create Daily Post - Admin Panel" />

        <div class="max-w-3xl mx-auto">
            <AdminPageHeader
                title="Create Daily Post & Update"
                description="Share a new technical insight, architectural breakdown, or helpful daily tip."
                :breadcrumbs="[
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <AppInput
                            ...
                            hint="Leave blank to auto-calculate from word count."
                    ...
                    <AppMediaUploader
                        ...
                        hint="Upload a featured image or architectural diagram (PNG, JPG, WEBP, SVG)"
                        accept="image/*"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                        ...
                        <AppInput
                            ...
                            hint="Defaults to current timestamp if published."
