...
const form = useForm({
    ...
    billing_period: props.plan.billing_period || 'project',
    description: props.plan.description || '',
    features: props.plan.features && props.plan.features.length ? [...props.plan.features] : [''],
    not_included: props.plan.not_included && props.plan.not_included.length ? [...props.plan.not_included] : [''],
    badge: props.plan.badge || '',
    is_featured: Boolean(props.plan.is_featured),
    is_active: Boolean(props.plan.is_active),
    sort_order: props.plan.sort_order ?? 0,
    cta_text: props.plan.cta_text || 'Get Started',
    cta_url: props.plan.cta_url || '#contact',
    documents: [],
});
...
const submit = () => {
    form.put(route('admin.pricing.update', props.plan.id));
};
</script>
    ...
    <AdminLayout>
        ...
        <div class="max-w-4xl mx-auto">
            <AdminPageHeader
                ...
                description="Update tier rates, feature deliverables, brochure documents, and visibility status."
                :breadcrumbs="[
