...
<template>
    <AdminLayout>
        <Head title="Add Portfolio Project - Admin Panel" />

        <div class="max-w-2xl mx-auto">
            <AdminPageHeader
                title="Add Portfolio Project"
                description="Showcase a real-world application, repository, or client platform on your portfolio."
                :breadcrumbs="[
            ...
            <AppCard>
                <form @submit.prevent="submit" class="space-y-5">
                    ...
                    <AppMediaUploader
                        ...
                        hint="Upload a project screenshot or cover image (PNG, JPG, WEBP, SVG)"
                        accept="image/*"
